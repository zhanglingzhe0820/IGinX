...
public class Migration extends AbstractUnaryOperator {
    ...
    public Migration(GlobalSource source, FragmentMeta fragmentMeta,
                     List<String> paths, List<StorageUnitMeta> targetReplicaStorageUnitMetaList) {
        super(OperatorType.Migration, source);
        this.fragmentMeta = fragmentMeta;
        this.paths = paths;
    ...
    public Operator copy() {
        return new Migration((GlobalSource) getSource().copy(), fragmentMeta, paths, targetReplicaStorageUnitMetaList);
    }
}
